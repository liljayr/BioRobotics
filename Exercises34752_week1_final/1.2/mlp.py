...
class Layer:
    def __init__(self, n_inputs, n_units, act_f):
        ...
        for i in range(n_units):
            self.ps.append(Perceptron(n_inputs, act_f, 0.5))
