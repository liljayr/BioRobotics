...
class Layer:
    def __init__(self, num_inputs, num_units, act_f):
        ...
        #     self.ps.append(Perceptron(num_inputs, Sigmoid, 0.5))
        
        # self.ps.append(Perceptron(num_inputs, LinearActivation, 0.5))
        # layer1 = Perceptron(num_inputs, Sigmoid, 0.5)
        # layer2 = Perceptron(num_inputs, Sigmoid, 0.5)
        # layer3 = Perceptron(num_inputs, Sigmoid, 0.5)
        # layer4 = Perceptron(num_inputs, Sigmoid, 0.5)
        # output = Perceptron(num_inputs, LinearActivation, 0.5)
        # self.ps = [layer1, layer2, layer3, layer4, output]
